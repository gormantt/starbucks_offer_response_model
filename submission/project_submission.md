...
The results of these two models are nearly identicaln, just as we saw above when comparing the tuned and untuned LightGBM models. The differences in accuracy and F1 scores can likely be attributed to the different thresholds used in those calculations between the two models
